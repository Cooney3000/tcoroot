...
$delimiter = '#';
  ...
  <table class="table table-light tbl-small">
    <tr>
      ...
      <th>
        Spielername<br>
        <a class="fas fa-angle-up fa-1x" href="bereitsAngemeldetBEdit.php?o=spielername&dir=asc"></a>&nbsp;&nbsp;
        <a class="fas fa-angle-down fa-1x" href="bereitsAngemeldetBEdit.php?o=spielername&dir=desc"></a>
      </th>
      <th>Kat<br>
      ...
      <th>Kommentar</th>
      <th>Anm-Dat<br>
        <a class="fas fa-angle-up fa-1x" href="bereitsAngemeldetBEdit.php?o=created_at&dir=asc"></a>&nbsp;&nbsp;
        <a class="fas fa-angle-down fa-1x" href="bereitsAngemeldetBEdit.php?o=created_at&dir=desc"></a>
      </th>
      <th>Aktionen</th>
    </tr> 
  <?php
  $tournament_id = $CONFIG['activeTournamentB'];
