...
<h1>Turnierteilnehmer B-Runde</h1>
...
$sql = "SELECT * FROM users u, tournament_players t WHERE u.id = user_id AND willing_to_play = 1 AND t.tournament_id = " .$CONFIG['activeTournamentB']. " ORDER BY ".$orderSQL;
// TECHO(DBG, $sql);
    ...
    <table class="table table-striped tbl-small">
      <thead>
        <tr>
          <th>#</th>
          <th>Spieler/in<br>
            <a class="fas fa-angle-up fa-1x" href="bereitsAngemeldetB.php?o=0&dir=asc"></a>&nbsp;&nbsp;
            <a class="fas fa-angle-down fa-1x" href="bereitsAngemeldetB.php?o=0&dir=desc"></a>
          </th>
          <th>Anm.
            <a class="fas fa-angle-up fa-1x" href="bereitsAngemeldetB.php?o=2&dir=asc"></a>&nbsp;&nbsp;
            <a class="fas fa-angle-down fa-1x" href="bereitsAngemeldetB.php?o=2&dir=desc"></a>
          </th>
          <th>LK<br>
            <a class="fas fa-angle-up fa-1x" href="bereitsAngemeldetB.php?o=1&dir=asc"></a>&nbsp;&nbsp;
            <a class="fas fa-angle-down fa-1x" href="bereitsAngemeldetB.php?o=1&dir=desc"></a>
          </th>
          <th>Telefon<br>
          </th>
          <th>Komm.</th>
