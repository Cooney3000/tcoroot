...
$turnier = $CONFIG["activeTournamentJ"];
$sql = <<<EOT
SELECT 
...
WHERE 
  b.booking_type = '$turniertyp' 
  AND t1.tournament_id = t2.tournament_id 
  AND starts_at > '2020-06-01' AND b.booking_state = 'A' 
  AND t1.tournament_id = $turnier
ORDER BY $orderSQL
