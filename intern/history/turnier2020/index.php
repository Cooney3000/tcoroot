...
<div class="container main-container">
  ...
  <!-- <div class="my-3"><img class="img-fluid" src="/intern/history/turnier2021/images/amperkurier.jpg" alt="Amper Kurier" /></div> -->
    ...
    <div>
      <p class="h5">Turnierbaum</p>
      <a href="images/spielplan_damenb.jpg"><img src="images/spielplan_damenb.jpg" class="w-50" alt="Damen B"></a>
    </div>
  ...
  <article id="herrenergebnisseB">
    ...
    <ol>
      <h2 class="my-1"><li>Norbert Maier</li></h2>
      <h2 class="my-1"><li>Marcus Mülleneisen</li></h2>
    </ol>
   <br>
    <div>
      <p class="h5">Turnierbaum</p>
      <a href="images/spielplan_herrenb.jpg"><img src="images/spielplan_herrenb.jpg" class="w-50" alt="Herren B"></a>
    </div>
