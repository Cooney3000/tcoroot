...
?>
			...
			<section id="mitgliedschaft" class="seite">
				...
				<article>    
					<table class="betont">
						<thead>
							<tr>
								<th>Mitgliedschaft</th><th class="geldbetrag">Jahresbeitrag</th><th class="mittig">Reduzierung durch Arbeitseinsatz möglich</th>
							</tr>
						</thead>
						<tbody>
							<tr>
		...
		<div id="blatt2">
          ...
          Bitte gehe auf Petra Eder zu:  (08142) 12451, Mail <a href="petra.eder@tcolching.de">petra.eder@tcolching.de</a>
          </p>
					<p>
                ...
                Wird bis zu diesem Datum die reguläre Mitgliedschaft für das Folgejahr beantragt, kann bis zum Saisonende ohne Mehrkosten weitergespielt werden!</strong>
					...
					<p>Bei Interesse erreichst du uns telefonisch unter (08142) 12451, per E-Mail unter <a href="petra.eder@tcolching.de">petra.eder@tcolching.de</a>. 
		...
		<div id="blatt5">
			<section id="vorstand" class="seite">
				...
				<article id="visitenkarten">
					...
					<div class="visitenkarte">
						<img alt="Michael Sachse" src="images/vorstand/michael_sachse.jpg">
					...
					<div class="visitenkarte">
						<img alt="Andrea Gallert" src="images/vorstand/andrea_gallert.jpg">
            ...
            <a href="mailto:presse@tcolching.de">presse@tcolching.de</a>
					...
					<div class="visitenkarte">
						<img alt="Lisa Fuchs" src="images/vorstand/lisa_fuchs.jpg">
		...
		<div id="blatt4">
			<section id="uebernachtung" class="seite">
				<div class="fliessenderAbschnitt">
					<h3>Anfragen an</h3>
					<p>
				...
				<div>
					<img src="images/uebernachtungen.png" alt="Übernachtungen">
				</div>
				<div class="fliessenderAbschnitt">
